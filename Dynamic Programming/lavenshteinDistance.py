...
# Notice that when source[col] ==  target[row] (ie both characters are same), result is same as matrix[row-1][col-1] cz you can just ignore the current character (as it's a no op)
